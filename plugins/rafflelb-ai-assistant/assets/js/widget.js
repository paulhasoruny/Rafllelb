(function () {
    ...
    ready(function () {
        ...
        function appendLinkifiedText(container, text) {
            ...
            while ((match = urlPattern.exec(text)) !== null) {
                ...
                try {
                    ...
                    allowed = (target.protocol === 'https:' || target.protocol === 'http:') && target.origin === site.origin;
                } catch (error) {
                    allowed = false;
                }
        ...
        function addMessage(role, text, tone) {
            ...
            appendLinkifiedText(bubble, String(text));
        ...
        form.addEventListener('submit', function (event) {
            ...
            fetch(config.restUrl, {
                ...
                typing.remove();
                addMessage('assistant', 'I’m sorry, the assistant could not respond right now. Please try again later.', 'system');
            }).finally(function () {
                busy = false;
