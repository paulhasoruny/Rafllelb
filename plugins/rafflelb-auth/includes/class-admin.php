...
final class RaffleLB_Auth_Admin {
    ...
    public static function page() {
        ...
        <div class="wrap"><h1>RaffleLB → Authentication</h1><p>Auth-owned SMS and verification settings. Best SMS Bulk / PROXIREACH is available as a production SMS transport.</p>
        ...
        <?php self::credential_row('bsb_secured_key', 'API Secured Key', 'RAFFLELB_BSB_SECURED_KEY', $s, 'password'); ?>
