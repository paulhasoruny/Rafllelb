...
final class RaffleLB_Auth_Registration {
    ...
    public static function create() {
        ...
        $email = sanitize_email(self::post('email')); $password = self::post('password'); $confirm = self::post('confirm_password');
        ...
        $user = RaffleLB_Auth_User_Service::create_customer($state['phone'], $email, $password, $id);
