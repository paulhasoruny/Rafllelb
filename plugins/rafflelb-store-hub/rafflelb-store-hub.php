...
final class RaffleLB_Store_Hub {
    ...
    private static function render_raffle_slide($row, $index = 0) {
        ...
        <article class="rlsh-raffle-slide<?php echo $index === 0 ? ' is-active' : ''; ?>" data-rlsh-raffle-slide aria-hidden="<?php echo $index === 0 ? 'false' : 'true'; ?>">
            <div class="rlsh-raffle-feature-copy">
                ...
                <div class="rlsh-raffle-feature-row">
                ...
                <div class="rlsh-raffle-feature-actions">
                    <a class="rlsh-enter" href="<?php echo esc_url($url); ?>"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 10a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v1a2 2 0 0 0 0 4v1a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-1a2 2 0 0 0 0-4Z"></path><path d="M13 8v8" stroke-dasharray="1.5 2.2"></path></svg>ENTER RAFFLE <b>→</b></a>
                    <?php if ($selection): ?><a class="rlsh-selection" href="<?php echo esc_url($selection); ?>"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M4 20V10"></path><path d="M12 20V4"></path><path d="M20 20v-7"></path></svg>VIEW SELECTION STATUS <b>→</b></a><?php endif; ?>
                </div>
            </div>
    ...
    public static function shortcode() {
        ...
        /* 0.1.18 — Live Raffles: dedicated cinematic stage asset for the product side + stronger left-side hierarchy (consolidated; replaces the 0.1.17 layer). */
        ...
        .rlsh-raffle-stage{position:relative;height:500px}
        .rlsh-raffle-slide{position:absolute;inset:0;display:grid;grid-template-columns:minmax(0,45%) minmax(0,55%);opacity:0;visibility:hidden;pointer-events:none;transition:opacity .25s ease,visibility .25s ease}
        ...
        .rlsh-raffle-feature-badge{align-self:flex-start;display:inline-flex;align-items:center;margin:0;padding:7px 13px;border-radius:999px;background:linear-gradient(180deg,#ff3347,#f0152f);box-shadow:0 0 18px rgba(255,40,62,.2);color:#fff;font-size:9.5px;font-weight:800;letter-spacing:.06em}
        .rlsh-raffle-feature-badge i{display:inline-block;width:5px;height:5px;margin-right:6px;border-radius:50%;background:#fff}
        .rlsh-raffle-feature-status{display:inline-flex;align-items:center;min-height:28px;padding:7px 13px;border:1px solid rgba(186,255,0,.32);border-radius:999px;background:rgba(186,255,0,.03);color:var(--lime);font-size:9.5px;font-weight:700;letter-spacing:.05em}
        .rlsh-raffle-feature-copy h3{display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;overflow:hidden;max-width:540px;margin:0 0 8px!important;color:#fff!important;font-size:clamp(28px,2.7vw,42px)!important;line-height:1.14!important;font-weight:800!important;letter-spacing:-.02em!important}
        .rlsh-raffle-feature-copy h3 a{color:#fff!important}
        .rlsh-raffle-feature-desc{display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:1;overflow:hidden;max-width:500px;margin:0 0 16px!important;color:#b8c1b5!important;font-size:13.5px!important;line-height:1.5!important;font-weight:400!important}

        .rlsh-raffle-feature-row{display:flex;align-items:stretch;gap:10px;flex-wrap:wrap;margin:0 0 18px}
        .rlsh-raffle-feature-pricebox,.rlsh-raffle-metric{border:1px solid #2b382b;border-radius:13px;background:linear-gradient(145deg,rgba(16,25,16,.94),rgba(7,12,7,.96));box-shadow:inset 0 1px 0 rgba(255,255,255,.02)}
        .rlsh-raffle-feature-pricebox{display:grid;grid-template-columns:auto auto;grid-template-areas:'label label' 'price unit';align-content:center;column-gap:8px;min-width:196px;padding:14px 20px}
        .rlsh-raffle-feature-pricebox>span{grid-area:label;margin-bottom:3px;color:#c0c9bd;font-size:10px;font-weight:600;letter-spacing:.04em}
        .rlsh-raffle-feature-pricebox>strong{grid-area:price;color:var(--lime);font-size:32px;line-height:1;font-weight:800;letter-spacing:-.02em}
        .rlsh-raffle-feature-pricebox>small{grid-area:unit;align-self:end;padding-bottom:2px;color:#d3d9d1;font-size:10.5px;font-weight:500}
        .rlsh-raffle-metric{display:flex;min-width:82px;padding:12px 12px;flex-direction:column;align-items:center;justify-content:center;text-align:center}
        .rlsh-raffle-metric-icon{display:flex;align-items:center;justify-content:center;width:17px;height:17px;margin-bottom:6px;color:#8b9787}
        ...
        .rlsh-raffle-metric strong{color:#f7faf5;font-size:19px;line-height:1;font-weight:800}
        .rlsh-raffle-metric.is-filled strong{color:var(--lime)}
        .rlsh-raffle-metric span{margin-top:5px;color:#8b9787;font-size:8.5px;font-weight:700;letter-spacing:.05em}

        .rlsh-raffle-feature-progress{display:flex;align-items:center;gap:14px;max-width:480px;margin:0 0 20px}
        .rlsh-raffle-feature-track{flex:1 1 auto;height:13px;min-width:0;border-radius:99px;background:rgba(255,255,255,.07);overflow:hidden;box-shadow:inset 0 1px 3px rgba(0,0,0,.4)}
        .rlsh-raffle-feature-track span{position:relative;display:block;height:100%;border-radius:inherit;background:linear-gradient(90deg,#96e000,#d0ff00);box-shadow:0 0 14px rgba(186,255,0,.45)}
        .rlsh-raffle-feature-progress>strong{flex:0 0 auto;color:#f5f7f2;font-size:14px;font-weight:800}

        .rlsh-raffle-feature-actions{display:flex;align-items:center;gap:14px;margin-top:2px}
        .rlsh-raffle-feature-actions .rlsh-enter,.rlsh-raffle-feature-actions .rlsh-selection{display:inline-flex;align-items:center;justify-content:center;gap:9px;min-width:220px;min-height:52px;padding:0 24px;border-radius:11px;font-size:13px;font-weight:700;letter-spacing:.03em;white-space:nowrap}
        .rlsh-raffle-feature-actions .rlsh-enter{background:var(--lime);color:#071000!important;box-shadow:0 0 22px rgba(186,255,0,.14)}
        .rlsh-raffle-feature-actions .rlsh-selection{min-width:260px;border:1px solid #50672a;background:rgba(3,7,3,.55);color:#f5f7f2!important}
        .rlsh-raffle-feature-actions .rlsh-enter b,.rlsh-raffle-feature-actions .rlsh-selection b{margin-left:0;font-weight:500}
        .rlsh-raffle-feature-actions .rlsh-enter svg,.rlsh-raffle-feature-actions .rlsh-selection svg{width:15px;height:15px;flex:0 0 auto}

        /* ===== right-side cinematic product stage: dedicated generic SVG scene, no product baked in ===== */
        .rlsh-raffle-feature-visual{position:relative;isolation:isolate;display:flex;align-items:center;justify-content:center;min-width:0;overflow:hidden;background-color:#020402;background-repeat:no-repeat;background-size:cover;background-position:40% 50%;background-image:url("data:image/svg+xml,%3Csvg%20width=%221920%22%20height=%221080%22%20viewBox=%220%200%201920%201080%22%20xmlns=%22http://www.w3.org/2000/svg%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3CradialGradient%20id=%22bg%22%20cx=%220.5%22%20cy=%220.34%22%20r=%220.8%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%220%22%20stop-color=%22%230e1a10%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%220.45%22%20stop-color=%22%23081008%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%221%22%20stop-color=%22%23020402%22/%3E%0A%20%20%20%20%3C/radialGradient%3E%0A%20%20%20%20%3CradialGradient%20id=%22halo%22%20cx=%220.5%22%20cy=%220.5%22%20r=%220.5%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%220%22%20stop-color=%22%23baff00%22%20stop-opacity=%220.5%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%220.55%22%20stop-color=%22%23baff00%22%20stop-opacity=%220.2%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%221%22%20stop-color=%22%23baff00%22%20stop-opacity=%220%22/%3E%0A%20%20%20%20%3C/radialGradient%3E%0A%20%20%20%20%3CradialGradient%20id=%22well%22%20cx=%220.5%22%20cy=%220.5%22%20r=%220.5%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%220%22%20stop-color=%22%23020402%22%20stop-opacity=%220.92%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%220.6%22%20stop-color=%22%23020402%22%20stop-opacity=%220.6%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%221%22%20stop-color=%22%23020402%22%20stop-opacity=%220%22/%3E%0A%20%20%20%20%3C/radialGradient%3E%0A%20%20%20%20%3ClinearGradient%20id=%22terrainL%22%20x1=%220%22%20y1=%220%22%20x2=%220.7%22%20y2=%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%220%22%20stop-color=%22%231c3012%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%221%22%20stop-color=%22%23050a04%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%20%20%3ClinearGradient%20id=%22terrainR%22%20x1=%221%22%20y1=%220%22%20x2=%220.3%22%20y2=%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%220%22%20stop-color=%22%23182a09%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%221%22%20stop-color=%22%23050a04%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%20%20%3ClinearGradient%20id=%22floor%22%20x1=%220%22%20y1=%220%22%20x2=%220%22%20y2=%221%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%220%22%20stop-color=%22%2308120a%22%20stop-opacity=%220%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%221%22%20stop-color=%22%2308120a%22%20stop-opacity=%220.8%22/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%20%20%3CradialGradient%20id=%22podiumGlow%22%20cx=%220.5%22%20cy=%220.5%22%20r=%220.5%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%220%22%20stop-color=%22%23baff00%22%20stop-opacity=%220.4%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%220.6%22%20stop-color=%22%23baff00%22%20stop-opacity=%220.14%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%221%22%20stop-color=%22%23baff00%22%20stop-opacity=%220%22/%3E%0A%20%20%20%20%3C/radialGradient%3E%0A%20%20%20%20%3CradialGradient%20id=%22podiumTop%22%20cx=%220.5%22%20cy=%220.3%22%20r=%220.7%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%220%22%20stop-color=%22%232b4020%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%221%22%20stop-color=%22%23050a04%22/%3E%0A%20%20%20%20%3C/radialGradient%3E%0A%20%20%20%20%3CradialGradient%20id=%22vignette%22%20cx=%220.5%22%20cy=%220.4%22%20r=%220.7%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%220.5%22%20stop-color=%22%23000%22%20stop-opacity=%220%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset=%221%22%20stop-color=%22%23000%22%20stop-opacity=%220.6%22/%3E%0A%20%20%20%20%3C/radialGradient%3E%0A%20%20%20%20%3Cfilter%20id=%22soft6%22%20x=%22-50%25%22%20y=%22-50%25%22%20width=%22200%25%22%20height=%22200%25%22%3E%3CfeGaussianBlur%20stdDeviation=%226%22/%3E%3C/filter%3E%0A%20%20%20%20%3Cfilter%20id=%22soft14%22%20x=%22-80%25%22%20y=%22-80%25%22%20width=%22260%25%22%20height=%22260%25%22%3E%3CfeGaussianBlur%20stdDeviation=%2216%22/%3E%3C/filter%3E%0A%20%20%3C/defs%3E%0A%0A%20%20%3Crect%20width=%221920%22%20height=%221080%22%20fill=%22url%28%23bg%29%22/%3E%0A%0A%20%20%3Cpath%20d=%22M0,1080%20L0,640%20L140,585%20L260,632%20L360,548%20L480,605%20L560,558%20L640,622%20L640,1080%20Z%22%20fill=%22url%28%23terrainL%29%22/%3E%0A%20%20%3Cpath%20d=%22M0,1080%20L0,700%20L120,645%20L230,688%20L320,628%20L400,665%20L400,1080%20Z%22%20fill=%22%23040804%22%20opacity=%220.8%22/%3E%0A%20%20%3Cpath%20d=%22M0,640%20L140,585%20L260,632%20L360,548%20L480,605%20L560,558%20L640,622%22%20fill=%22none%22%20stroke=%22%23baff00%22%20stroke-opacity=%220.34%22%20stroke-width=%223.5%22/%3E%0A%0A%20%20%3Cpath%20d=%22M1920,1080%20L1920,630%20L1780,575%20L1660,626%20L1560,535%20L1440,598%20L1360,545%20L1280,616%20L1280,1080%20Z%22%20fill=%22url%28%23terrainR%29%22/%3E%0A%20%20%3Cpath%20d=%22M1920,1080%20L1920,690%20L1800,638%20L1690,678%20L1600,618%20L1520,656%20L1520,1080%20Z%22%20fill=%22%23040804%22%20opacity=%220.8%22/%3E%0A%20%20%3Cpath%20d=%22M1920,630%20L1780,575%20L1660,626%20L1560,535%20L1440,598%20L1360,545%20L1280,616%22%20fill=%22none%22%20stroke=%22%23baff00%22%20stroke-opacity=%220.34%22%20stroke-width=%223.5%22/%3E%0A%0A%20%20%3Ccircle%20cx=%22960%22%20cy=%22160%22%20r=%22560%22%20fill=%22url%28%23halo%29%22/%3E%0A%20%20%3Cellipse%20cx=%22960%22%20cy=%22420%22%20rx=%22380%22%20ry=%22460%22%20fill=%22url%28%23well%29%22/%3E%0A%0A%20%20%3Crect%20x=%220%22%20y=%22660%22%20width=%221920%22%20height=%22420%22%20fill=%22url%28%23floor%29%22/%3E%0A%0A%20%20%3Cellipse%20cx=%22960%22%20cy=%22965%22%20rx=%22640%22%20ry=%22130%22%20fill=%22%23000%22%20opacity=%220.5%22%20filter=%22url%28%23soft14%29%22/%3E%0A%20%20%3Cellipse%20cx=%22960%22%20cy=%22925%22%20rx=%22560%22%20ry=%2290%22%20fill=%22url%28%23podiumGlow%29%22/%3E%0A%20%20%3Cellipse%20cx=%22960%22%20cy=%22915%22%20rx=%22470%22%20ry=%2244%22%20fill=%22url%28%23podiumTop%29%22/%3E%0A%20%20%3Cellipse%20cx=%22960%22%20cy=%22915%22%20rx=%22470%22%20ry=%2244%22%20fill=%22none%22%20stroke=%22%23baff00%22%20stroke-opacity=%220.7%22%20stroke-width=%223%22/%3E%0A%20%20%3Cellipse%20cx=%22960%22%20cy=%22915%22%20rx=%22470%22%20ry=%2244%22%20fill=%22none%22%20stroke=%22%23baff00%22%20stroke-opacity=%220.22%22%20stroke-width=%2216%22%20filter=%22url%28%23soft6%29%22/%3E%0A%20%20%3Cellipse%20cx=%22960%22%20cy=%22934%22%20rx=%22330%22%20ry=%2218%22%20fill=%22%23000%22%20opacity=%220.32%22%20filter=%22url%28%23soft6%29%22/%3E%0A%0A%20%20%3Crect%20width=%221920%22%20height=%221080%22%20fill=%22url%28%23vignette%29%22/%3E%0A%3C/svg%3E%0A")}
        .rlsh-raffle-feature-visual img.rlsh-raffle-feature-img{position:relative;z-index:2;width:auto!important;height:74%!important;max-width:76%!important;object-fit:contain!important;filter:drop-shadow(0 30px 22px rgba(0,0,0,.55));transform:translateX(-8%);-webkit-mask-image:radial-gradient(ellipse 60% 66% at 50% 50%,#000 52%,rgba(0,0,0,.55) 74%,transparent 100%);mask-image:radial-gradient(ellipse 60% 66% at 50% 50%,#000 52%,rgba(0,0,0,.55) 74%,transparent 100%)}

        .rlsh-raffle-controls{position:absolute;inset:0;display:block;pointer-events:none;z-index:6}
        .rlsh-raffle-controls>button{position:absolute;top:50%;width:40px;height:40px;padding:0;transform:translateY(-50%);border:1px solid #4f5f49;border-radius:50%;background:rgba(4,7,4,.7);backdrop-filter:blur(6px);color:#fff;font-size:20px;line-height:1;pointer-events:auto;transition:border-color .18s ease,background .18s ease}
        .rlsh-raffle-controls>button:hover{border-color:var(--lime);background:rgba(8,14,8,.9)}
        .rlsh-raffle-controls>[data-rlsh-raffle-prev]{left:18px}
        .rlsh-raffle-controls>[data-rlsh-raffle-next]{right:18px}
        .rlsh-raffle-dots{position:absolute;right:66px;bottom:22px;z-index:7;display:flex;align-items:center;gap:6px;pointer-events:auto}
        .rlsh-raffle-dots button{width:17px;height:3px;padding:0;border:0;border-radius:99px;background:#54604e}
        .rlsh-raffle-dots button.is-active{width:29px;background:var(--lime);box-shadow:0 0 10px rgba(186,255,0,.25)}

        @media(max-width:1400px){
        .rlsh-raffle-stage{height:462px}
        .rlsh-raffle-feature-copy{padding:30px 34px}
        .rlsh-raffle-feature-copy h3{font-size:clamp(24px,2.3vw,32px)!important}
        .rlsh-raffle-feature-pricebox>strong{font-size:27px}
        }
        @media(max-width:900px){
        .rlsh-raffle-stage{height:770px}
        .rlsh-raffle-slide{grid-template-columns:1fr;grid-template-rows:310px 1fr}
        .rlsh-raffle-feature-visual{grid-row:1;background-position:50% 50%}
        .rlsh-raffle-feature-visual img.rlsh-raffle-feature-img{transform:none}
        .rlsh-raffle-feature-copy{grid-row:2;padding:26px 26px}
        .rlsh-raffle-feature-copy h3{max-width:none;font-size:clamp(25px,3.4vw,32px)!important}
        .rlsh-raffle-feature-desc{max-width:none}
        .rlsh-raffle-controls{height:310px}
        .rlsh-raffle-controls>button{top:155px}
        .rlsh-raffle-dots{top:272px;bottom:auto}
        }
        @media(max-width:600px){
        .rlsh-raffles{padding-top:24px;padding-bottom:28px}
        .rlsh-raffle-showcase{border-radius:14px}
        .rlsh-raffle-stage{height:870px}
        .rlsh-raffle-slide{grid-template-rows:250px 1fr}
        .rlsh-raffle-feature-copy{padding:22px 18px 26px}
        .rlsh-raffle-feature-badge,.rlsh-raffle-feature-status{padding:6px 11px;font-size:8.5px}
        .rlsh-raffle-feature-copy h3{font-size:24px!important;margin-bottom:7px!important}
        .rlsh-raffle-feature-desc{margin-bottom:13px!important;font-size:12.5px!important}
        .rlsh-raffle-feature-row{gap:8px}
        .rlsh-raffle-feature-pricebox{min-width:0;width:100%;padding:12px 16px}
        .rlsh-raffle-metric{flex:1 1 calc(50% - 4px);min-width:0}
        .rlsh-raffle-feature-progress{max-width:none;margin-bottom:18px}
        .rlsh-raffle-feature-actions{flex-wrap:wrap;gap:10px}
        .rlsh-raffle-feature-actions .rlsh-enter,.rlsh-raffle-feature-actions .rlsh-selection{flex:1 1 100%;min-width:0;min-height:48px}
        .rlsh-raffle-controls{height:250px}
        .rlsh-raffle-controls>button{top:125px;width:36px;height:36px;font-size:18px}
        .rlsh-raffle-controls>[data-rlsh-raffle-prev]{left:10px}
        .rlsh-raffle-controls>[data-rlsh-raffle-next]{right:10px}
        .rlsh-raffle-dots{right:auto;left:50%;top:216px;bottom:auto;transform:translateX(-50%)}
        }
        </style>
